    ...
    public class GameTables
    {
        ...
        public void SetGridDot(int i, int j)
        {
            ...
            if (IsWin(i, j))
            {
                ...
                string message = nextColor == 0 ? "黑方胜，赢得积分10。白方扣10积分。" : "白方胜，赢得积分10。黑方扣10积分。";
                if(nextColor == 0)
                {
                    Service1.win(players[0].UserName);
                    Service1.fail(players[1].UserName);
                }else
                {
                    Service1.fail(players[0].UserName);
                    Service1.win(players[1].UserName);
                }
